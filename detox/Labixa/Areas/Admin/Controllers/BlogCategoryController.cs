...
namespace Labixa.Areas.Admin.Controllers
{
    ...
    public class BlogCategoryController : Controller
    {
        ...
        {
            var list = _blogCategoryService.GetBlogCategories().Where(s=> s.Id == 4);
        ...
        {
            var listCategory = _blogCategoryService.GetBlogCategories().Where(s => s.Id == 4 || s.Id == 16 || s.Id == 7 || s.Id == 17 || s.Id == 17
